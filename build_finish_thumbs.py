...
Usage:
    python build_finish_thumbs.py <masters_dir> <category> <out_dir>

Example:
    python build_finish_thumbs.py ./masters/cabinet cabinet ./frontend/public/finishes/cabinet
