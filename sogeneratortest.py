...
# # from cabinet_odoo import get_cabinet
...
# #     # ── CHANGED: cabinet now comes from Odoo instead of the local DB ───────
# #     cabinet = get_cabinet(model)
# #     if not cabinet:
# #         failed_rows.append({
# #             "Row": index + 1, "Model": model,
# #             "Cabinet Position": reference,
# #             "Reason": "Cabinet not found in Odoo",
# #         })
# #         return False
...
# #     crm_id = project_id
# #     print(f"Extracted Project ID: {crm_id}")
# #     project_name, customer, poc = get_customer_poc(crm_id)
# #     print(f"Retrieved from Odoo: Project Name: {project_name}, Customer: {customer}, POC: {poc}")
